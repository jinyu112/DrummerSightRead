...
public class MetronomeTick extends MidiEvent
{
    ...
    private com.leff.midi.event.meta.TimeSignature mSignature;
    ...
    public MetronomeTick(com.leff.midi.event.meta.TimeSignature sig, int resolution)
    {
        super(0, 0);
    ...
    public void setTimeSignature(com.leff.midi.event.meta.TimeSignature sig)
    {
        mSignature = sig;
        mCurrentBeat = 0;
    ...
    public void setMetronomeFrequency(int meter)
    {
        switch(meter)
        {
            case com.leff.midi.event.meta.TimeSignature.METER_EIGHTH:
                mMetronomeFrequency = mResolution / 2;
                break;
            case com.leff.midi.event.meta.TimeSignature.METER_QUARTER:
                mMetronomeFrequency = mResolution;
                break;
            case com.leff.midi.event.meta.TimeSignature.METER_HALF:
                mMetronomeFrequency = mResolution * 2;
                break;
            case com.leff.midi.event.meta.TimeSignature.METER_WHOLE:
