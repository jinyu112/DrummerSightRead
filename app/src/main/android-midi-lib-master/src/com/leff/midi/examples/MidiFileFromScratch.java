...
public class MidiFileFromScratch
{
    public static void main(String[] args)
    {
        ...
        com.leff.midi.event.meta.TimeSignature_leff ts = new com.leff.midi.event.meta.TimeSignature_leff();
        ts.setTimeSignature(4, 4, com.leff.midi.event.meta.TimeSignature_leff.DEFAULT_METER, com.leff.midi.event.meta.TimeSignature_leff.DEFAULT_DIVISION);
