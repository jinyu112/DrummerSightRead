...
public class MidiProcessor
{
    ...
    public MidiProcessor(MidiFile input)
    {
        ...
        mMetronome = new MetronomeTick(new com.leff.midi.event.meta.TimeSignature_leff(), mPPQ);
    ...
    public void reset()
    {
        ...
        mMetronome.setTimeSignature(new com.leff.midi.event.meta.TimeSignature_leff());
    ...
    protected void dispatch(MidiEvent event)
    {
        ...
        else if(event.getClass().equals(com.leff.midi.event.meta.TimeSignature_leff.class))
        {

            boolean shouldDispatch = mMetronome.getBeatNumber() != 1;
            mMetronome.setTimeSignature((com.leff.midi.event.meta.TimeSignature_leff) event);
